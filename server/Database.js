...
class Database {
  ...
  buildModels(force = false) {
    ...
    require('./models/KnowledgeSource').init(this.sequelize)
    require('./models/KnowledgeJob').init(this.sequelize)
    require('./models/KnowledgeDocument').init(this.sequelize)
    require('./models/KnowledgeAsset').init(this.sequelize)
