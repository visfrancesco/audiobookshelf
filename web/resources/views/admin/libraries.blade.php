...
@endforeach</div><details class="panel" @if($edit || $errors->any()) open @endif><summary>{{ $edit ? 'Edit library' : 'Create a library' }}</summary><form method="post" action="{{ route('manage.action', ['libraries', 'save', $edit['id'] ?? null]) }}" class="stack">
